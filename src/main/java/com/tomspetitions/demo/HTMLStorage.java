...
public class HTMLStorage {
    ...
    public String createPetitionPage(){
        ...
        myHTML += navBar();            
        myHTML +="""
                <form action="/newresult" method="post" class="myColumnContainer">
    ...
    public String searchPetitionPage(){
        ...
        myHTML += navBar();                    
        myHTML +="""
                <form action="/searchAction" method="get" class = "myColumnContainer">
    ...
    public String viewPetitionsPage(ArrayList<Petition> petitions){
        ...
        for (Petition petition : petitions){
            ...
            myHTML += String.format("""
                <tr>
                    ...
                    <td class="listCol"> %s </td>
                    <td class="buttonCol"> <a href='/sign/%d'><button class="updateButton">Sign</button></a> </td>
                    <td class="buttonCol"><a href='/delete/%d'><button class="deleteButton">Delete</button></a> </td>
                </tr>        
            """,petition.getTitle(),petition.getDescription(),signatureString,emailString,petition.getId(),petition.getId());
        }
    ...
    public String signPetitionPage(Petition petition){
        String myHTML = """
            <html>
            <head>
                <link rel="stylesheet" href="/myStyle.css">
        ...
        myHTML += String.format(""" 
            <div class='myColumnContainer'>
                ...
                <form action="/signaction/%d" method="post" class="myColumnContainer">
        ...
        """,petition.getTitle(),petition.getDescription(),petition.getId());
        
        return myHTML;
    }

    // This page is simply used to display any notification passed to it as a string
    public String notificationPage(String notification){
        String myHTML = """
            <html>
            <head>
                <link rel="stylesheet" href="/myStyle.css">
